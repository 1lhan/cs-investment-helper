...
export default function Signup() {
    ...
    const handleSignup = async (e) => {
        ...
        if (username.length < 3) formMessage.value = 'Username must be at least 3 characters long.'
        else if (email.length < 15) formMessage.value = 'Email must be at least 15 characters long.'
        else if (password.length < 8) formMessage.value = 'Password must be at least 8 characters long.'
        else if (password != confirmPassword) formMessage.value = 'Passwords do not match.'
        else {
